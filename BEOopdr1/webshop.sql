...
--
-- Host: localhost:3306
-- Gegenereerd op: 25 mei 2021 om 07:37
-- Serverversie: 8.0.22
-- PHP-versie: 8.0.2
...
--
-- Tabelstructuur voor tabel `aanspreektitels`
--

CREATE TABLE `aanspreektitels` (
  `aanspreektitelid` int NOT NULL,
...
CREATE TABLE `gebruikers` (
  ...
  `aanspreektitelid` int DEFAULT NULL,
...
(1, 'Christiano Ronaldo', 'Plaza 15', 'Haarlem', 'CR7@gmail.com', '0612345678', 'Tom van der Plas', 'Aerobic fit', '2021-04-01', 6, '29.99'),
...
(4, 'Marcel de Jong', 'Kerkstraat 6', 'Haarlem', 'MDJ81@gmail.com', '062345671', 'Tom van der Plas', 'Aerobic fit', '2021-04-01', 6, '29.99'),
...
(7, 'Frenkie van Basten', 'Saharalaan 86', 'Hoofddorp', 'Frenkienr1@strato.nl', '0678901234', 'Tom van der Plas', 'Aerobic fit', '2021-03-01', 6, '29.99'),
(8, 'Lisa Steen', 'Chopinstraat 312', 'Hoofddorp', 'SteenLisa23@gmail.com', '0689012345', 'Tom van der Plas', 'Aerobic fit', '2021-03-01', 6, '29.99'),
(9, 'Graciano Pele', 'Abbapad 23', 'Amsterdam', 'Grpellatio@gmail.com', '0611223344', 'Tom van der Plas', 'Aerobic fit', '2021-06-15', 6, '29.99'),
(10, 'Samanta van Viet', 'Piet-Heinstraat 12', 'Amsterdam', 'SammieV@gmail.com', '062233445566', 'Tom van der Plas', 'Aerobic fit', '2021-04-01', 6, '29.99'),
(11, 'Maarten Vos', 'Balistraat 15', 'Delft', 'CR7@gmail.com', '0655667788', 'Mohamed Ali', 'Box Fit', '2021-04-01', 6, '49.50'),
...
(14, 'Justin Hemmer', 'Kerkstraat 6', 'Haarlem', 'MDJ81@gmail.com', '0656656776', 'Mohamed Ali', 'Box Fit', '2021-04-01', 6, '49.50'),
...
(17, 'Camil Kalen', 'Saharalaan 86', 'Hoofddorp', 'Frenkienr1@strato.nl', '0665478562', 'Mohamed Ali', 'Box Fit', '2021-03-01', 6, '49.50'),
(18, 'Hanna de Gtoor', 'Beethovenlaan 312', 'Hoofddorp', 'SteenLisa23@gmail.com', '0626547821', 'Mohamed Ali', 'Box Fit', '2021-03-01', 6, '49.50'),
(19, 'Marlies Westen', 'Abbapad 23', 'Rotterdam', 'Grpellatio@gmail.com', '0623423568', 'Mohamed Ali', 'Box Fit', '2021-06-15', 6, '49.50'),
(20, 'Marcel Sammella', 'Piet-Heinstraat 12', 'Rotterdam', 'SammieV@gmail.com', '0619283735', 'Mohamed Ali', 'Box Fit', '2021-04-01', 6, '49.50'),
(21, 'Thijn van Vliet', 'Bachlaan 15', 'Haarlem', 'CR7@gmail.com', '0612375678', 'Bernadet Kamp', 'Bootcamp', '2021-04-01', 10, '23.25'),
...
(24, 'Marcel de Jong', 'Borodinlaan 6', 'Zaandam', 'MDJ81@gmail.com', '062375671', 'Bernadet Kamp', 'Bootcamp', '2021-04-01', 7, '23.25'),
...
(27, 'Jesse Wang', 'Nigeriaronde 686', 'Hoofddorp', 'Frenkienr1@strato.nl', '0678301237', 'Bernadet Kamp', 'Bootcamp', '2021-03-01', 6, '23.25'),
(28, 'Lars Hoogendoorn', 'Canada 312', 'Beverwijk', 'SteenLisa23@gmail.com', '0683012375', 'Bernadet Kamp', 'Bootcamp', '2021-03-01', 12, '23.25'),
(29, 'Timo van Eijk', 'Europa 23', 'Amsterdam', 'Grpellatio@gmail.com', '0611822564', 'Bernadet Kamp', 'Bootcamp', '2021-06-15', 14, '23.25'),
(30, 'Ron Schuurmans', 'Piet-Donnerlaan 12', 'Beverwijk', 'SammieV@gmail.com', '068225645502', 'Bernadet Kamp', 'Bootcamp', '2021-04-01', 8, '23.25'),
(31, 'Roben de Laat', 'Grieglaan 27', 'Rotterdam', 'CR7@gmail.com', '0655026488', 'Bowie aan de Vecht', 'Body Combat', '2021-04-01', 12, '73.50'),
...
(34, 'Jack Hamerslag', 'Pergolesstraat 6', 'Haarlem', 'MDJ81@gmail.com', '0650256646', 'Bowie aan de Vecht', 'Body Combat', '2021-04-01', 9, '73.50'),
...
(37, 'Trijntje van Westeren', 'Smetanalaan 86', 'Hoofddorp', 'Frenkienr1@strato.nl', '0025648562', 'Bowie aan de Vecht', 'Body Combat', '2021-03-01', 10, '73.50'),
...
(39, 'Theo Ladiala', 'Diepenbrocklaan 12', 'Rotterdam', 'SammieV@gmail.com', '0613283735', 'Bowie aan de Vecht', 'Body Combat', '2021-04-01', 6, '73.50');
...
INSERT INTO `producten` (`productenid`, `categorie`, `omschrijving`, `foto`, `prijs`) VALUES
(1, 'Groepsles', 'Body Combat', './images/bodycombat.jpg', '29.99'),
(2, 'Groepsles', 'Aerobic fit', './images/aerobic.jpg', '55.00'),
(3, 'Groepsles', 'Bootcamp', './images/bootcamp.jpg', '20.50'),
(4, 'Groepsles', 'Box fit', './images/boxen.jpg', '35.00');
...
--
ALTER TABLE `aanspreektitels`
  MODIFY `aanspreektitelid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT voor een tabel `gebruikers`
--
ALTER TABLE `gebruikers`
  MODIFY `gebruikerid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT voor een tabel `inschrijvingen`
--
ALTER TABLE `inschrijvingen`
  MODIFY `inschrijvingenid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
